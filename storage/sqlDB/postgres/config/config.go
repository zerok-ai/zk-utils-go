...
type PostgresConfig struct {
	...
	User                           string `yaml:"user" env:"ZK_POSTGRES_USERNAME" env-description:"Postgres user"`
	Password                       string `yaml:"password" env:"ZK_POSTGRES_PASSWORD" env-description:"Postgres password"`
